...
const SERVICE_ICONS: Record<string, string> = {
  zap: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m13 2-8 12h6l-1 8 8-12h-6l1-8Z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/></svg>',
  droplet: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3s6 6.2 6 11a6 6 0 1 1-12 0c0-4.8 6-11 6-11Z" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M9 16a3 3 0 0 0 3 2" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',
  hammer: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m14 5 5 5M4 20l9-9M8 4l3 3-4 4-3-3 4-4Zm5-1 8 8-3 3-8-8 3-3Z" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/></svg>',
  snowflake: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3v18M4.2 7.5l15.6 9M4.2 16.5l15.6-9M12 3l2 2M12 3l-2 2M12 21l2-2M12 21l-2-2" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg>',
  paint: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 17h12a4 4 0 0 0 0-8H8a4 4 0 0 0 0 8h9" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M8 17v4M5 21h6" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>',
  broom: '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m14 4 6 6M13 5l-8 8 6 6 8-8M5 19l-2 2M10 14l-4 4" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>'
};
      ...
      <head>
        ...
        <style>{`
          ...
          *{box-sizing:border-box}body{margin:0;font-family:Inter,ui-sans-serif,system-ui,-apple-system,'Segoe UI',sans-serif;background:var(--bg);color:var(--navy);line-height:1.5;-webkit-font-smoothing:antialiased}
          ...
          .service-icon svg{width:22px;height:22px;display:block}.service:hover .service-icon{background:var(--blue);color:#fff}.service:focus-visible,.btn:focus-visible,.worker:focus-visible{outline:3px solid rgba(11,108,255,.28);outline-offset:3px}
